/* ============================================================
   ...
   main.js — loads all Vega-Lite specs from graph/ folder
 ...
 * @param {string} specFile  - path to the JSON spec (e.g. 'graph/01_choropleth.json')
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  loadAndEmbed('graph/14_species_fatality.json',        'vis-treemap');
